...
@Controller // Bean 등록
@RequestMapping("todo") // todo로 시작사는 요청 매핑
public class TodoController {
	...
	public String addTodo(
		...
		//서비스 메서드 로출 후 결과 반환 받기
		int result = service.addTodo(todoTitle, todoContent);
		
		//삽입 결과에 다라 message 값 지정
		String message = null;
	...
	@GetMapping("delete")
	public String todoDelete(@RequestParam("todoNo") int todoNo, Model model, RedirectAttributes ra){
